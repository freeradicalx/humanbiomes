...
public class BiomeGenTest2 extends BiomeGenBase{

	public BiomeGenTest2(int par1) {
		super(par1);
        this.setBiomeName("Test Biome 2");
        		...
        		if (yCount == 0){
        			for (int xCount = 0; xCount < 16; xCount++){
        				for (int zCount = 0; zCount < 16; zCount++){
        					world.setBlock(x + xCount, height + yCount, z + zCount, Block.wood.blockID);
        					int n = height - 1;
        					while (world.getBlockId(x + xCount, n, z + zCount) == 0){
        						world.setBlock(x + xCount, n, z + zCount, Block.wood.blockID);
        						n--;
        			...
        			for (int xCount = 0; xCount < 16; xCount++){
        				for (int zCount = 0; zCount < 16; zCount++){
        					if ((xCount == 2 || xCount == 13) && (zCount > 1 && zCount < 14)){
        						world.setBlock(x + xCount, height + yCount, z + zCount, Block.planks.blockID);
        					}
